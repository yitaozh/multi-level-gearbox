#ifndef QUEUE_GEARBOX_THREE_LEVELS_ORIGIN_H
#define QUEUE_GEARBOX_THREE_LEVELS_ORIGIN_H
...
class Gearbox_pl_fid_3levels_original : public Queue {
private:
...
public:
    Gearbox_pl_fid_3levels_original();
    explicit Gearbox_pl_fid_3levels_original(int);
    void enque(Packet*);
    Packet* deque();
