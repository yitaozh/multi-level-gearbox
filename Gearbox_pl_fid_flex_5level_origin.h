...
class Gearbox_pl_fid_5levels_origin : public Queue {
private:
    static const int DEFAULT_VOLUME = 5;
    static const int FIFO_PER_LEVEL = 6;         // 01212020 Peixuan flex level
    static const int STEP_DOWN_FIFO = 3;         // 01212020 Peixuan flex level
    ...
    Level thirdLevelB;    // Back up Level_flexs
    Level hundredLevelB;    // Back up Level_flexs
...
public:
    Gearbox_pl_fid_5levels_origin();
    explicit Gearbox_pl_fid_5levels_origin(int);
    void enque(Packet*);
    Packet* deque();
