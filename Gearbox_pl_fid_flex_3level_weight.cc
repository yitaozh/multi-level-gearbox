...
Gearbox_pl_fid_flex::Gearbox_pl_fid_flex(int volume_) {
    ...
    ///fprintf(stderr, "Gearbox has: %d levels, %d fifos_ in level 0\n", sizeof(levels)/sizeof(levels[0]), levels[0].size()); // Debug: Peixuan 01072020
    ///fprintf(stderr, "Gearbox has: %d fifos_ in level 1, %d fifos_ in level 2, %d fifos_ in level 3, %d fifos_ in level 4\n", levels[1].size(), levels[2].size(), levels[3].size(), levels[4].size()); // Debug: Peixuan 01072020
    ///fprintf(stderr, "Gearbox has: %d levels B, %d fifos_ in level 0 B\n", sizeof(levelsB)/sizeof(levelsB[0]), levelsB[0].size()); // Debug: Peixuan 01072020
    ///fprintf(stderr, "Gearbox has: %d fifos_ in level 1 B, %d fifos_ in level 2 B, %d fifos_ in level 3 B, %d fifos_ in level 4 B\n", levelsB[1].size(), levelsB[2].size(), levelsB[3].size(), levelsB[4].size()); // Debug: Peixuan 01072020
    ///fprintf(stderr, "Gearbox has: %d fifos_ in decade level, %d fifos_ in hundred level 2, %d fifos_ in third level\n", decadeLevel.size(), hundredLevel.size(), thirdLevel.size()); // Debug: Peixuan 01072020
    ///fprintf(stderr, "Gearbox has: %d fifos_ in decadeB level, %d fifos_ in hundredB level 2, %d fifos_ in thirdB level\n", decadeLevelB.size(), hundredLevelB.size(), thirdLevelB.size()); // Debug: Peixuan 01072020
