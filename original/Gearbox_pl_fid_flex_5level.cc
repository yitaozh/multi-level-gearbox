...
public:
        Gearbox_pl_fid_flex_5levelsClass() : TclClass("Queue/GearboxPLFL5Levels") {}
        TclObject* create(int, const char*const*) {
            // fprintf(stderr, "Created new TCL HCSPL instance\n"); // Debug: Peixuan 07062019
	        return (new Gearbox_pl_fid_5levels);
	}
} class_hierarchical_queue;

Gearbox_pl_fid_5levels::Gearbox_pl_fid_5levels():Gearbox_pl_fid_5levels(DEFAULT_VOLUME) {
    // fprintf(stderr, "Created new HCSPL instance\n"); // Debug: Peixuan 07062019
}

Gearbox_pl_fid_5levels::Gearbox_pl_fid_5levels(int volume) {
...
void Gearbox_pl_fid_5levels::setCurrentRound(int currentRound) {
...
void Gearbox_pl_fid_5levels::setPktCount(int pktCount) {
    ///fprintf(stderr, "Set Packet Count: %d\n", pktCount); // Debug: Peixuan 07072019
    this->pktCount = pktCount;
}

void Gearbox_pl_fid_5levels::enque(Packet* packet) {
    ...
    */
    ...
    // Debug print
    fprintf(stderr, "Gearbox5: fid %d update level %d\n", iph->flowid(), flow_max_level[iph->flowid()]);
...
int Gearbox_pl_fid_5levels::cal_theory_departure_round(hdr_ip* iph, int pkt_size) {
    //int		fid_;	/* flow id */
    //int		prio_;
    // parameters in iph
    // TODO
...
Packet* Gearbox_pl_fid_5levels::deque() {
...
vector<Packet*> Gearbox_pl_fid_5levels::runRound() {
...
vector<Packet*> Gearbox_pl_fid_5levels::serveUpperLevel(int currentRound) {
...
// 12132019 Peixuan
//Flow_pl* Gearbox_pl_fid_5levels::getFlowPtr(nsaddr_t saddr, nsaddr_t daddr) {
Flow* Gearbox_pl_fid_5levels::getFlowPtr(int fid) {
...
//Flow_pl* Gearbox_pl_fid_5levels::insertNewFlowPtr(nsaddr_t saddr, nsaddr_t daddr, int weight, int brustness) {
Flow* Gearbox_pl_fid_5levels::insertNewFlowPtr(int fid, int weight, int brustness) { // Peixuan 04212020
...
//int Gearbox_pl_fid_5levels::updateFlowPtr(nsaddr_t saddr, nsaddr_t daddr, Flow_pl* flowPtr) {
int Gearbox_pl_fid_5levels::updateFlowPtr(int fid, Flow* flowPtr) { // Peixuan 04212020
    //pair<ns_addr_t, ns_addr_t> key = make_pair(saddr, daddr);
    //string key = convertKeyValue(saddr, daddr);
    string key = convertKeyValue(fid);  // Peixuan 04212020
...
//string Gearbox_pl_fid_5levels::convertKeyValue(nsaddr_t saddr, nsaddr_t daddr) {
string Gearbox_pl_fid_5levels::convertKeyValue(int fid) { // Peixuan 04212020
    stringstream ss;
    //ss << saddr;
    //ss << ":";
    //ss << daddr;
